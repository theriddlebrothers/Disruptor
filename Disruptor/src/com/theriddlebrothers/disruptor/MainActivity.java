...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPlayer = MediaPlayer.create(MainActivity.this, R.raw.annoy);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			        ...
			        boolean fromUser)
			{
				...
				MainActivity.this.currentMeterThreshold = newProgress;				
			}
    ...
    private class MonitorDecibelsTask extends TimerTask {
	   public void run() {
		   ...
		   if (amplitude >= MainActivity.this.currentMeterThreshold && !isPlaying) {
			   Log.d(TAG, "Threshold reached: " + Double.toString(amplitude));
			   playSound();
		   } else if(amplitude < MainActivity.this.currentMeterThreshold && isPlaying) {
